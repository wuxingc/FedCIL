...
from utilstools.toolkit import tensor2numpy, accuracy
from scipy.spatial.distance import cdist
from utilstools.data_manager import DummyDataset, _get_idata
...
class BaseLearner(object):
    ...
    def eval_task(self, args, old_classes):
        y_pred, y_true = self._eval_cnn(self.test_loader, args["scale"], old_classes=old_classes)
    ...
    def _compute_accuracy(self, model, loader, scale=False, old_classes=0):
        model.eval()
        correct, total = 0, 0
        for i, (_, inputs, targets) in enumerate(loader):
            ...
            with torch.no_grad():
                ...
                if scale:
                    logits_old = outputs[:, :old_classes] / self.args['tau_old']
                    logits_new = outputs[:, old_classes:] / self.args['tau_new']
    ...
    def _eval_cnn(self, loader, scale=False, old_classes=0):
        self._network.eval()
        y_pred, y_true = [], []
